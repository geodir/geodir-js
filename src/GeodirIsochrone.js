...
GeodirIsochrone = function (args) {
    this.time_limit = 600;
    this.distance_limit = 0;
    this.buckets = 3;
    this.vehicle = "car";
    this.point;
    this.host = "https://api.geodir.co/api/v1/isochrone";
    this.debug = false;
...
GeodirIsochrone.prototype.getParametersAsQueryString = function (args) {
...
GeodirIsochrone.prototype.doRequest = function (reqArgs) {
    var that = this;
    ...
    return new Promise(function(resolve, reject) {
        ...
        var url = args.host + "?" + that.getParametersAsQueryString(args) + "&key=" + args.key;
...
module.exports = GeodirIsochrone;